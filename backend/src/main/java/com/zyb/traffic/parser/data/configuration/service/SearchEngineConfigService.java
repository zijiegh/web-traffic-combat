package com.zyb.traffic.parser.data.configuration.service;

import com.zyb.traffic.parser.data.configuration.ReferUrlAndParams;
import com.zyb.traffic.parser.data.configuration.SearchEngineConfig;
import com.zyb.traffic.parser.data.configuration.loader.SearchEngineConfigLoader;
import com.zyb.traffic.parser.data.configuration.loader.impl.FileSearchEngineConfigLoader;
