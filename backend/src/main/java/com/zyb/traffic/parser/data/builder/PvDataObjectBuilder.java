...
import com.zyb.traffic.parser.data.builder.helper.SearchEngineNameUtil;
import com.zyb.traffic.parser.data.builder.helper.TargetPageAnalyzer;
import com.zyb.traffic.parser.data.configuration.TargetConfigMatcher;
import com.zyb.traffic.parser.data.object.BaseDataObject;
import com.zyb.traffic.parser.data.object.PvDataObject;
import com.zyb.traffic.parser.data.object.TargetPageDataObject;
import com.zyb.traffic.parser.data.object.dim.*;
import com.zyb.traffic.parser.data.utils.ColumnReader;
import com.zyb.traffic.parser.data.utils.ParserUtils;
import com.zyb.traffic.parser.data.utils.UrlInfo;
...
public class PvDataObjectBuilder extends AbstractDataObjectBuilder {
     ...
     * @return
     */
    private TargetPageDataObject populateTargetPageObject(LogPreparser preParsedLog,
